...
class NextrackerFetcher(CompanyFetcher):
    """Nextracker 爬蟲"""

    company_id = "nextracker"
    company_name = "Nextracker"
    news_url = "https://www.nextracker.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.nextracker.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Nextracker")
        return documents
