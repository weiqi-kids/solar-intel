...
class XinyiSolarFetcher(CompanyFetcher):
    """Xinyi Solar 爬蟲"""

    company_id = "xinyi_solar"
    company_name = "Xinyi Solar"
    news_url = "https://www.xinyisolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.xinyisolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Xinyi Solar")
        return documents
