...
class EnphaseFetcher(CompanyFetcher):
    """Enphase Energy 爬蟲"""

    company_id = "enphase"
    company_name = "Enphase Energy"
    news_url = "https://www.enphaseenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.enphaseenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Enphase Energy")
        return documents
