...
class GclFetcher(CompanyFetcher):
    """GCL Technology 爬蟲"""

    company_id = "gcl"
    company_name = "GCL Technology"
    news_url = "https://www.gcltechnology.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.gcltechnology.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from GCL Technology")
        return documents
