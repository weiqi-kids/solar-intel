...
class CanadianSolarFetcher(CompanyFetcher):
    """Canadian Solar 爬蟲"""

    company_id = "canadian_solar"
    company_name = "Canadian Solar"
    news_url = "https://www.canadiansolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.canadiansolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Canadian Solar")
        return documents
