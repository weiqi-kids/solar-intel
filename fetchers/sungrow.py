...
class SungrowFetcher(CompanyFetcher):
    """Sungrow Power Supply 爬蟲"""

    company_id = "sungrow"
    company_name = "Sungrow Power Supply"
    news_url = "https://www.sungrowpowersupply.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sungrowpowersupply.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sungrow Power Supply")
        return documents
