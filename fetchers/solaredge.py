...
class SolaredgeFetcher(CompanyFetcher):
    """SolarEdge Technologies 爬蟲"""

    company_id = "solaredge"
    company_name = "SolarEdge Technologies"
    news_url = "https://www.solaredgetechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.solaredgetechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from SolarEdge Technologies")
        return documents
