...
class TrinaFetcher(CompanyFetcher):
    """Trina Solar 爬蟲"""

    company_id = "trina"
    company_name = "Trina Solar"
    news_url = "https://www.trinasolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.trinasolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Trina Solar")
        return documents
