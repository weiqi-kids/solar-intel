...
class JinkoFetcher(CompanyFetcher):
    """JinkoSolar 爬蟲"""

    company_id = "jinko"
    company_name = "JinkoSolar"
    news_url = "https://www.jinkosolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.jinkosolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from JinkoSolar")
        return documents
