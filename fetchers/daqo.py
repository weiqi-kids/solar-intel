...
class DaqoFetcher(CompanyFetcher):
    """Daqo New Energy 爬蟲"""

    company_id = "daqo"
    company_name = "Daqo New Energy"
    news_url = "https://www.daqonewenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.daqonewenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Daqo New Energy")
        return documents
