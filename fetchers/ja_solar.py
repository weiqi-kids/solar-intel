...
class JaSolarFetcher(CompanyFetcher):
    """JA Solar 爬蟲"""

    company_id = "ja_solar"
    company_name = "JA Solar"
    news_url = "https://www.jasolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from JA Solar")
        return documents
