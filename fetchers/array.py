...
class ArrayFetcher(CompanyFetcher):
    """Array Technologies 爬蟲"""

    company_id = "array"
    company_name = "Array Technologies"
    news_url = "https://www.arraytechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.arraytechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Array Technologies")
        return documents
