...
class RisenFetcher(CompanyFetcher):
    """Risen Energy 爬蟲"""

    company_id = "risen"
    company_name = "Risen Energy"
    news_url = "https://www.risenenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.risenenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Risen Energy")
        return documents
