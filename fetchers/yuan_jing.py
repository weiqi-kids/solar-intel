...
class YuanJingFetcher(CompanyFetcher):
    """Yuan Jing Solar 爬蟲"""

    company_id = "yuan_jing"
    company_name = "Yuan Jing Solar"
    news_url = "https://www.yuanjingsolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.yuanjingsolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Yuan Jing Solar")
        return documents
