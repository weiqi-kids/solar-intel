...
class MeyerBurgerFetcher(CompanyFetcher):
    """Meyer Burger 爬蟲"""

    company_id = "meyer_burger"
    company_name = "Meyer Burger"
    news_url = "https://www.meyerburger.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.meyerburger.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Meyer Burger")
        return documents
