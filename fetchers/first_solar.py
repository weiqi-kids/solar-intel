...
class FirstSolarFetcher(CompanyFetcher):
    """First Solar 爬蟲"""

    company_id = "first_solar"
    company_name = "First Solar"
    news_url = "https://www.firstsolar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.firstsolar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from First Solar")
        return documents
