...
class TongweiFetcher(CompanyFetcher):
    """Tongwei 爬蟲"""

    company_id = "tongwei"
    company_name = "Tongwei"
    news_url = "https://www.tongwei.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Tongwei")
        return documents
