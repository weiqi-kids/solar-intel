"""
Maxeon Solar Technologies 官網爬蟲
"""
...
class MaxeonFetcher(CompanyFetcher):
    """Maxeon Solar Technologies 爬蟲"""

    company_id = "maxeon"
    company_name = "Maxeon Solar Technologies"
    news_url = "https://www.maxeonsolartechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.maxeonsolartechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Maxeon Solar Technologies")
        return documents
