...
class MotechFetcher(CompanyFetcher):
    """Motech Industries 爬蟲"""

    company_id = "motech"
    company_name = "Motech Industries"
    news_url = "https://www.motechindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.motechindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Motech Industries")
        return documents
