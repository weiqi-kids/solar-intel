...
class LongiFetcher(CompanyFetcher):
    """LONGi Green Energy 爬蟲"""

    company_id = "longi"
    company_name = "LONGi Green Energy"
    news_url = "https://www.longigreenenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.longigreenenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from LONGi Green Energy")
        return documents
